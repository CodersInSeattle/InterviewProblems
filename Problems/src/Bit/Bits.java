public class Bits {
	...
	public static void main(String[] args) {
		int[] inputs = {0xffffffff, 0x0f0f0f0f};
		System.out.println("Testting bitCount():");
		for (int i : inputs) System.out.println(Integer.toHexString(i) + " " + bitCount(i));
		System.out.println("Testting bitCountLong():");
		for (int i : inputs) System.out.println(Integer.toHexString(i) + " " + bitCountLong(i));
	}
}